...
| --- | --- | --- |
| `rawType` | 34 | The one axis of the scale with no gate: a token edit moves the controls and leaves these behind. |
| `patternClass` | 308 | Nineteen screens drawing their own header is why pages stop looking alike; the shared component already exists. |
