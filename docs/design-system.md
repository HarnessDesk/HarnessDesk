...
| `patternClass` | 24 | Fourteen screens draw their own page header and ten their own empty state, at different paddings and different sizes, while PageHead and EmptyState sit unused in the design system. It is why two pages that do the same thing do not look alike. |
