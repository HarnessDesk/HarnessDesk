...
| page | 20 / semibold | the name of a place — a settings page, a review; it matches the wordmark (owner decision 2026-09-19) |
...
| 600 | reserved — the sidebar's app name only |
