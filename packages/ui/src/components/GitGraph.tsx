...
const LANE_TINTS = {
  '--lane-0': 'var(--hd-tint-blue-ink)',
  '--lane-1': 'var(--hd-tint-rose-ink)',
  '--lane-2': 'var(--hd-tint-amber-ink)',
  '--lane-3': 'var(--hd-tint-violet-ink)',
  '--lane-4': 'var(--hd-tint-teal-ink)',
  '--lane-5': 'var(--hd-tint-orange-ink)',
  '--lane-6': 'var(--hd-tint-sky-ink)',
  '--lane-7': 'var(--hd-tint-green-ink)',
} as CSSProperties
...
export const GitGraph = ({ row, lanes, rowHeight: ROW, laneWidth: LANE_W, className, offGraphClassName }: {
  ...
  return (
    <svg className={className} style={LANE_TINTS} width={Math.max(lanes.columns, 1) * LANE_W} height={ROW} aria-hidden="true">
      <g strokeWidth={1.5}>
