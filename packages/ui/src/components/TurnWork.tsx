...
/* The shimmer sweep: all appearance (gradient, clip, colour, keyframes) is
   composed here so TurnWork.module.css stays layout-only. The gradient is
   wider than the text and an animation slides it across; background-clip: text
   makes the sweep visible only through the letter shapes. */
const SHIMMER_CLASSES = [
  ...
  '[--tw-enter-translate-x:0]', // keep Tailwind from injecting a default
