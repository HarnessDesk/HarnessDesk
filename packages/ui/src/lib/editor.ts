  ...
  EditorView.theme(
    {
      ...
      '.cm-activeLineGutter': { backgroundColor: 'transparent', color: 'var(--hd-secondary-foreground)' },
      ...
      '.cm-panels': {
        backgroundColor: 'var(--hd-card)',
        color: 'var(--hd-foreground)',
        borderColor: 'var(--hd-border)',
      },
      '.cm-panel input, .cm-panel button': {
        fontFamily: 'inherit',
        backgroundColor: 'var(--hd-background)',
        color: 'var(--hd-foreground)',
