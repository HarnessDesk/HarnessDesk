...
lines.push('list only goes down, except when the audit learns to see something it was blind to:')
lines.push('`looseTarget` rose when it first read a stylesheet with a hyphen in its name (#91).')
lines.push('')
